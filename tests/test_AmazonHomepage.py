...
class TestAmazonHomepage():
    def test_signIn(self):
        ...
        assert location != "https://www.amazon.com.tr/", "sayfasına başarıyla gidilmiştir."
    ...
    def test_controlBoxesPicturesAndTexts(self):
        ...
        for i in location:
            for k in i:
                assert k != "https://www.amazon.com.tr/", "sayfasına başarıyla gidilmiştir."

    def test_homeCoverPhotoChangeClickAndPhoto(self):
        amazonHomepagePage=AmazonHomepagePage(self.driver)
        location = amazonHomepagePage.homeCoverPhotoChangeClickAndPhotoControl()
        for i in location:
            assert i != "https://www.amazon.com.tr/" , "sayfasına başarıyla gidilmiştir."
